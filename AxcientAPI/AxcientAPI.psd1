...
Description = 'A PowerShell module for the Axcient x360Recover public API'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'PSEdition_Desktop','PSEdition_Core','Windows','Linux','MacOS','Axcient','x360Recover','Axcient_x360Recover'
        ...
        ReleaseNotes = 'Version 0.2.0 supports the July 2024 API Schema'
